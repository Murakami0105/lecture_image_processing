...
![1/8サンプリング](picture/r01_4.jpg)  
図4．1/8サンプリング

	IMG = imresize(IMG,0.5); % 画像の縮小(1/16)
	IMG2 = imresize(IMG,16,'box'); % 画像の拡大
![1/16サンプリング](picture/r01_5.jpg)  
図5．1/16サンプリング

	IMG = imresize(IMG,0.5); % 画像の縮小(1/32)
	IMG2 = imresize(IMG,32,'box'); % 画像の拡大
![1/32サンプリング](picture/r01_6.jpg)  
図6．1/32サンプリング

縮小率が大きくなっていくと，それに対応するだけ同じ画素の塊ができてモザイク状の歪みが発生する．箱型の画素の数が解像度となっている．  
縮小率が小さくなればなるほどモザイクの一つ一つの大きさは小さくなり，個数も増加していく．個数が多い，つまり解像度が高いと，画像は見やすくなり，内容を目で認識しやすくなる．  
元の画像の解像度が高いため，1/2サンプリングなどでは差が出にくいが，1/32まで行くとモザイクが目立つようになっている．
